# -*- coding: utf-8 -*-
"""
Created on Sat Jul  1 16:18:44 2023
...
data = pd.read_csv("F:/2023 project code/Machine Learning Approaches on Polycystic Ovary Syndrome/PCOS 100% Code/PCOS.csv")
data = data.dropna()
